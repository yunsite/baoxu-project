...
function exceptionHandler(){
    ...
    if($user_defined_err['type'] > 0){
        switch($user_defined_err['type']){
            case 1:
                $user_defined_errType = 'E_ERROR';
                break;
            case 2:
                $user_defined_errType = 'E_WARNING';
                break;
            case 4:
            ...
            case 16:
                ...
                break;
            case 32:
                $user_defined_errType = 'E_CORE_WARNING';
                break;
            case 64:
                $user_defined_errType = 'E_COMPILE_ERROR';
                break;
            case 128:
                $user_defined_errType = 'E_COMPILE_WARNING';
                break;
            case 256:
                $user_defined_errType = 'E_USER_ERROR';
                break;
            case 512:
                $user_defined_errType = 'E_USER_WARNING';
                break;
            case 1024:
                $user_defined_errType = 'E_USER_NOTICE';
                break;
            case 2048:
                $user_defined_errType = 'E_STRICT';
                break;
            case 4096:
                $user_defined_errType = 'E_RECOVERABLE_ERROR';
                break;
            case 8191:
                $user_defined_errType = 'E_ALL';
                break;
            default:
