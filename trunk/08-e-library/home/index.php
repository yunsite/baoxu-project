...
<head>
    ...
    <style type = "text/css">
        .bx-author{ padding: 2px 0; }

        .bx-title{ padding-top: 5px; }

        .bx-summry{ padding: 2px 0; font-size: 12px; }

        .bx-book-img img{ height: 160px; margin-right: 5px; }
    </style>
</head>
<body>
...
<div class = "container">
    <div class = "hero-unit">
        <h1>Just, Read!</h1>
        <p class = "lead muted"><em>He who loveth a book will never want a faithful friend, a wholesome counsellor, a
                                    cheerful companion, or an effectual comforter.</em></p>
    ...
    <div class = "row">
        <div class = "span4">
            <h2>新书</h2>
            <div class = "f-fl bx-book-img">
                <a href = "#"><img src = "../img/book_default_img.png" class = "img-polaroid"></a></div>
            <div>
