...
CREATE TABLE `book` (
  ...
  PRIMARY KEY (`book_id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='书籍信息表';
...
) ENGINE=MyISAM AUTO_INCREMENT=1256 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户信息表';

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1255', '等门铃', 'bxchen@corp.netease.com', '202cb962ac59075b964b07152d234b70', '0', '0', '', '', '0', '2013-04-04', '0000-00-00', '0', '074130e386641794c485e80245853e9f');
