...
<div class = "container">
    ...
    <form class = "form-horizontal" name = "userRegister" id = "userRegister" action = "../admin/user_save.php" onsubmit="return verifyRegistForm();" enctype="multipart/form-data" method = "post">
        ...
        <div class = "control-group">
            ...
            <div class = "controls">
                <input type = "text" id = "mail" name = "mail" class = "span2" required = "required" placeholder = "Corp邮箱前缀">
        ...
        <div class = "control-group">
            ...
            <div class = "controls">
                <input type = "password" id = "password2" class = "span5" required = "required" placeholder = "再输入密码">
            </div>
        </div>
